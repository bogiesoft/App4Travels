...
App.controller('home', function (page) {
	...
	var btnSearch 			  = $(page).find('#btn-search'),
		...
		btnActivity 		  = $(page).find('#btn-Activity'),
		btnEntertainment 	  = $(page).find('#btn-Entertainment'),
		btnRestaurant 		  = $(page).find('#btn-Restaurant'),
		btnSpa 				  = $(page).find('#btn-Spa'),
		btnWedding 			  = $(page).find('#btn-Wedding'),
...
//api  app #1
$.ajax({
	url: API_URL + '/activity/locations?appKey='+APIKEY,
	dataType: 'JSON',
	method: 'GET',
	success: function(result){
...
//api app#2
$.ajax({
	url: API_URL + '/entertainment/locations?appKey='+APIKEY,
	dataType: 'JSON',
	method: 'GET',
	success: function(result){
		console.log("Entertainment Locations");
		console.log(result);
		result.locations.forEach(function(item){
			$('#location').append('<option value="'+item.id+'">'+item.name+'</option>');
		});
...
//api app #3
$.ajax({
	url: API_URL + '/restaurant/locations?appKey='+APIKEY,
	dataType: 'JSON',
	method: 'GET',
	success: function(result){
...
//api  app #4
$.ajax({
	url: API_URL + '/spa/locations?appKey='+APIKEY,
	dataType: 'JSON',
	method: 'GET',
	success: function(result){
		console.log("Spa Locations");
		console.log(result);
		result.locations.forEach(function(item){
			$('#location').append('<option value="'+item.id+'">'+item.name+'</option>');
		});
...
//api  app #5
$.ajax({
	url: API_URL + '/wedding/locations?appKey='+APIKEY,
	dataType: 'JSON',
	method: 'GET',
	success: function(result){
		console.log("Wedding Locations");
		console.log(result);
		result.locations.forEach(function(item){
			$('#location').append('<option value="'+item.id+'">'+item.name+'</option>');
		});
...
//Fill in activity types on location change
$(page).find('#location').change(function(){
	var loc = $(this).val();
	console.log(loc);
	$.ajax({
		url: API_URL + '/activity/activityTypes',
		type: 'GET',
		dataType: 'json',
		data: {appKey: APIKEY,location: loc},
	})
	.done(function(result) {
		...
		$('#activityTypes').empty();
		result.response.forEach(function(item){
			$('#activityTypes').append('<option value="'+item.name+'">'+item.name+'</option>');
		});
...
//Fill in entertainment types on location change
$(page).find('#location').change(function(){
	var loc = $(this).val();
	console.log(loc);
	$.ajax({
		url: API_URL + '/entertainment/entertainmentTypes',
		type: 'GET',
		dataType: 'json',
		data: {appKey: APIKEY,location: loc},
	})
	.done(function(result) {
		console.log(result);
		$('#entertainmentTypes').empty();
		result.response.forEach(function(item){
			$('#entertainmentTypes').append('<option value="'+item.name+'">'+item.name+'</option>');
		});
...
//Fill in restaurant types on location change
$(page).find('#location').change(function(){
	var loc = $(this).val();
	console.log(loc);
	$.ajax({
		url: API_URL + '/restaurant/restaurantTypes',
		type: 'GET',
		dataType: 'json',
		data: {appKey: APIKEY,location: loc},
	})
	.done(function(result) {
		console.log(result);
		$('#restaurantTypes').empty();
		result.response.forEach(function(item){
			$('#restaurantTypes').append('<option value="'+item.name+'">'+item.name+'</option>');
		});
...
//Fill in spa types on location change
$(page).find('#location').change(function(){
	var loc = $(this).val();
	console.log(loc);
	$.ajax({
		url: API_URL + '/spa/spaTypes',
		type: 'GET',
		dataType: 'json',
		data: {appKey: APIKEY,location: loc},
	})
	.done(function(result) {
		...
		$('#spaTypes').empty();
		result.response.forEach(function(item){
			$('#spaTypes').append('<option value="'+item.name+'">'+item.name+'</option>');
		});
...
//Fill in wedding types on location change
$(page).find('#location').change(function(){
	var loc = $(this).val();
	console.log(loc);
	$.ajax({
		url: API_URL + '/wedding/weddingTypes',
		type: 'GET',
		dataType: 'json',
		data: {appKey: APIKEY,location: loc},
	})
	.done(function(result) {
		...
		$('#weddingTypes').empty();
		result.response.forEach(function(item){
			$('#weddingTypes').append('<option value="'+item.name+'">'+item.name+'</option>');
		});
...
//end App#5
	...
	//Fill in car types on location change
...
$(page).find('#btnActivitySearch').on('click', function(){
	console.log('clicked');
	var location 	= $('#location').val();
	var type 		= $('#activityTypes').val();
	var guests 		= $('#guests').val();
	var date 		= $('#date').val();
	var data = {
			location: location,
	...
	if(location === null || date === ""){
		...
		App.load('activity', data);
	}

});

$(page).find('#btnEntertainmentSearch').on('click', function(){
	console.log('clicked');
	var location 	= $('#location').val();
	var type 		= $('#entertainmentTypes').val();
	var guests 		= $('#guests').val();
	var date 		= $('#date').val();
	var data = {
			location: location,
...
//restaurant
$(page).find('#btnRestaurantSearch').on('click', function(){
	console.log('clicked');
	var location 	= $('#location').val();
	var type 		= $('#restaurantuests').val();
	var date 		= $('#date').val();
	var data = {
			location: location,
			restaurantType: type,
	...
	if(location === null || date === ""){
		...
		App.load('restaurant', data);

	}

});
//spa
$(page).find('#btnSpaSearch').on('click', function(){
	console.log('clicked');
	var location 	= $('#location').val();
	var type 		= $('#spaTypes').val();
	var guests 		= $('#guests').val();
	var date 		= $('#date').val();
	var data = {
			location: location,
...
//wedding
$(page).find('#btnWeddingSearch').on('click', function(){
	console.log('clicked');
	var location 	= $('#location').val();
	var type 		= $('#weddingTypes').val();
	var guests 		= $('#guests').val();
	var date 		= $('#date').val();
	var data = {
			location: location,
...
//activity
	...
	url += '/activity/invoice?appKey='+APIKEY;
}

else if(data.btype === "entertainment"){
	params = {
		userId: 			get("userId"),
		itemid: data.itemid,
		adults: data.adults,
	...
	url += '/entertainment/invoice?appKey='+APIKEY;
}

else if(data.btype === "restaurant"){
	params = {
		userId: 			get("userId"),
		itemid: data.itemid,
		adults: data.adults,
	...
	url += '/restaurant/invoice?appKey='+APIKEY;
}

else if(data.btype === "spa"){
	params = {
		userId: 			get("userId"),
		itemid: data.itemid,
		adults: data.adults,
	...
	url += '/spa/invoice?appKey='+APIKEY;
}

else if(data.btype === "wedding"){
	params = {
		userId: 			get("userId"),
		itemid: data.itemid,
		adults: data.adults,
	...
	url += '/wedding/invoice?appKey='+APIKEY;
}
		...
		$.ajax({
			...
			success: function(data){
				...
				$('#hotelscombinedContainer').append(
					'<iframe src="//brands.datahc.com/?a_aid='+aid+'&brandid='+brandid+'&languageCode=EN" class="invoice" />'
...
//app#1 activity
//Show List
App.controller('activityList', function(page, data){
	// Apply theme to topbar and buttons based on current settings.
	if( get(Global.KEY_THEME_TOPBAR)  == 'true') applyTheme( $(page).find('.app-topbar') );
	else applyDefaultTheme ( $(page).find('.app-topbar') );
	if( get(Global.KEY_THEME_BUTTONS) == 'true') applyTheme( $(page).find('.btn') );
	...
	var appContent 		= $(page).find('.app-content');
	var activityListContainer = $(page).find('#activityListContainer');
	...
	$(page).on('appShow', function(){
		initComponents();
		console.log('appShow event has been triggered of activityList Page');
		try{
			Android.setText("NotHomePage");
		}catch(ex){
			console.log(ex.message);
	...
	appContent.scroll(function(){
		if(appContent.scrollTop() >= (activityListContainer.height() - appContent.height()))
	    {
	        if(!loading && moreAvailable){
	        	loadMoreActivity();
	        }
	...
	var offset = 1;
	var url = API_URL + '/activity/list';
	var params = {appKey: APIKEY, offset: offset};


	//restaurant template variables
	var $temp = $(page).find('.activity').remove();
	var $star = $temp.find('.material-icons').remove();

	setTimeout(function(){loadMoreActivity();}, 1000);
	...
	function loadMoreActivity(){
		...
		if(data.location){
			url = API_URL + '/activity/search';
			params = {
				appKey: APIKEY,
				offset: offset,
				location: data.location,
				restaurantType: data.activityType,
				adults: data.adults,
				date: data.date
			}
			console.log(params);
			...
			success: function(data){
				...
				if(!data.response.length == 0){
					data.response.forEach(function(item){
						...
						activityListContainer.append($temp2);
					});
				}
				initComponents();
				loading = false;
	...
	//Get activity id and date of clicked activity and send it to activity single page
	$(page).on('click', '.activity', function(){
		App.load('activity', {id: $(this).data('id'), date: $(this).data('date')});
	})

});

App.controller('activity', function(page, data){
	var swiperContainer = $(page).find('.swiper-container');
	var appContent 		= $(page).find('.app-content');
	var mainContainer 	= $(page).find('#activityDetailsContainer'); mainContainer.hide();
	console.log(data);
	...
	$(page).on('appShow', function(){
		console.log('appShow event has been triggered of activityDetailsPage');
	...
	setTimeout(function(){
		$.ajax({
			url: API_URL + '/activity/details',
			method: 'GET',
			dataType: 'JSON',
			data: {appKey: APIKEY, id: data.id},
			success: function(data){
				console.log(data.response);
				gallery = data.response.activity.sliderImages;
				data.response.activity.sliderImages.forEach(function(item){
					var $slide = $swiperSlide.clone(true);
					$slide.find('img').attr('src', item.fullImage);
					$slide.find('img').addClass('b-lazy');
					mySwiper.appendSlide($slide);
				...
				var pageTitle 		= $(page).find('.app-title');
				pageTitle.html(data.response.activity.title);

				$(page).find('#description').find('.desc').html(data.response.activity.desc);
	            ...
	            //Set row1 data of table body
	            row1.find('td:first-child').html('Adults '+data.response.activity.currSymbol + data.response.activity.perAdultPrice);

	            var optTemp = row1.find('td:nth-child(2) > select > option').remove();

	           	for(i = 1; i <= data.response.activity.maxAdults; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row1.find('select').append(opt);
	           	...
	           	row1.find('td:nth-child(3)').text(data.response.activity.currSymbol+ '' + data.response.activity.adultPrice + ' ' + data.response.activity.currCode);

	           	//Set row2 data of table body
	           	row2.find('td:first-child').text('Children '+data.response.activity.currSymbol + data.response.activity.perChildPrice);

	           	for(i = 1; i <= data.response.activity.maxChild; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row2.find('select').append(opt);
	           	...
	           	row2.find('td:nth-child(3)').text(data.response.activity.currSymbol+ '' + data.response.activity.childPrice + ' ' + data.response.activity.currCode);

	           	//Set row3 data of table body
	           	row3.find('td:first-child').text('Infants '+data.response.activity.currSymbol + data.response.activity.perInfantPrice);

	           	for(i = 1; i <= data.response.activity.maxInfant; i++){
	            	var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row3.find('select').append(opt);
	            ...
	            row3.find('td:nth-child(3)').text(data.response.activity.currSymbol+ '' + data.response.activity.infantPrice + ' ' + data.response.activity.currCode);

				//Set row4 data of table body
				//Set the date to input[type="date"] format yyyy-mm-dd
				var dateInput = data.response.activity.date.split('/').reverse().join('-');
				...
				data.response.activity.inclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('green-text');
					inclusions.append(listItem);
				...
				data.response.activity.exclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('red-text');
					exclusions.append(listItem);
...
//App#2
//Show List
App.controller('entertainmentList', function(page, data){
	// Apply theme to topbar and buttons based on current settings.
	if( get(Global.KEY_THEME_TOPBAR)  == 'true') applyTheme( $(page).find('.app-topbar') );
	else applyDefaultTheme ( $(page).find('.app-topbar') );
	if( get(Global.KEY_THEME_BUTTONS) == 'true') applyTheme( $(page).find('.btn') );
	...
	var appContent 		= $(page).find('.app-content');
	var entertainmentListContainer = $(page).find('#entertainmentListContainer');
	entertainmentListContainer.hide();
	...
	$(page).on('appShow', function(){
		initComponents();
		console.log('appShow event has been triggered of entertainmentListPage');
		try{
			Android.setText("NotHomePage");
		}catch(ex){
			console.log(ex.message);
	...
	appContent.scroll(function(){
		if(appContent.scrollTop() >= (entertainmentListContainer.height() - appContent.height()))
	    {
	        if(!loading && moreAvailable){
	...
	var offset = 1;
	var url = API_URL + '/entertainment/list';
	var params = {appKey: APIKEY, offset: offset};

	//tour template variables
	var $temp = $(page).find('.entertainment').remove();
	var $star = $temp.find('.material-icons').remove();

	setTimeout(function(){loadMoreEntertainment();}, 1000);

	function loadMoreEntertainment(){
		loading = true;
		$('.progress').show();
		...
		if(data.location){
			url = API_URL + '/entertainment/search';
			params = {
				appKey: APIKEY,
				offset: offset,
				location: data.location,
				tourType: data.entertainmentType,
				adults: data.adults,
				date: data.date
			}
			console.log(params);
		...
		$.ajax({
			...
			success: function(data){
				...
				$('.progress').hide();
				entertainmentListContainer.show();
				...
				if(!data.response.length == 0){
					data.response.forEach(function(item){
						...
						entertainmentListContainer.append($temp2);
					});
				}
				initComponents();
				loading = false;
	...
	//Get tour id and date of clicked tour and send it to tour single page
	$(page).on('click', '.activity', function(){
		App.load('entertainment', {id: $(this).data('id'), date: $(this).data('date')});
	})
...
//Detail
App.controller('entertainment', function(page, data){
	var swiperContainer = $(page).find('.swiper-container');
	var appContent 		= $(page).find('.app-content');
	var mainContainer 	= $(page).find('#entertainmentDetailsContainer'); mainContainer.hide();
	console.log(data);
	...
	$(page).on('appShow', function(){
		console.log('appShow event has been triggered of entertainmentDetailsPage');
	...
	setTimeout(function(){
		$.ajax({
			url: API_URL + 'entertainment/details',
			method: 'GET',
			dataType: 'JSON',
			data: {appKey: APIKEY, id: data.id},
			success: function(data){
				console.log(data.response);
				gallery = data.response.entertainment.sliderImages;
				data.response.entertainment.sliderImages.forEach(function(item){
					var $slide = $swiperSlide.clone(true);
					$slide.find('img').attr('src', item.fullImage);
					$slide.find('img').addClass('b-lazy');
					mySwiper.appendSlide($slide);
				...
				var pageTitle 		= $(page).find('.app-title');
				pageTitle.html(data.response.entertainment.title);

				$(page).find('#description').find('.desc').html(data.response.entertainment.desc);
	            ...
	            //Set row1 data of table body
	            row1.find('td:first-child').html('Adults '+data.response.entertainment.currSymbol + data.response.activity.perAdultPrice);

	            var optTemp = row1.find('td:nth-child(2) > select > option').remove();

	           	for(i = 1; i <= data.response.entertainment.maxAdults; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row1.find('select').append(opt);
	           	...
	           	row1.find('td:nth-child(3)').text(data.response.entertainment.currSymbol+ '' + data.response.entertainment.adultPrice + ' ' + data.response.entertainment.currCode);

	           	//Set row2 data of table body
	           	row2.find('td:first-child').text('Children '+data.response.entertainment.currSymbol + data.response.entertainment.perChildPrice);

	           	for(i = 1; i <= data.response.entertainment.maxChild; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row2.find('select').append(opt);
	           	...
	           	row2.find('td:nth-child(3)').text(data.response.entertainment.currSymbol+ '' + data.response.entertainment.childPrice + ' ' + data.response.entertainment.currCode);
	           	//Set row3 data of table body
	           	row3.find('td:first-child').text('Infants '+data.response.entertainment.currSymbol + data.response.entertainment.perInfantPrice);

	           	for(i = 1; i <= data.response.entertainment.maxInfant; i++){
	            	var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row3.find('select').append(opt);
	            ...
	            row3.find('td:nth-child(3)').text(data.response.entertainment.currSymbol+ '' + data.response.entertainment.infantPrice + ' ' + data.response.entertainment.currCode);

				//Set row4 data of table body
				//Set the date to input[type="date"] format yyyy-mm-dd
				var dateInput = data.response.entertainment.date.split('/').reverse().join('-');
				...
				data.response.entertainment.inclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('green-text');
					inclusions.append(listItem);
				...
				data.response.entertainment.exclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('red-text');
					exclusions.append(listItem);
...
//App#3
App.controller('restaurantList', function(page, data){
	// Apply theme to topbar and buttons based on current settings.
	if( get(Global.KEY_THEME_TOPBAR)  == 'true') applyTheme( $(page).find('.app-topbar') );
	else applyDefaultTheme ( $(page).find('.app-topbar') );
	if( get(Global.KEY_THEME_BUTTONS) == 'true') applyTheme( $(page).find('.btn') );
	...
	var appContent 		= $(page).find('.app-content');
	var restaurantListContainer = $(page).find('#restaurantListContainer');
	restaurantListContainer.hide();
	...
	$(page).on('appShow', function(){
		initComponents();
		console.log('appShow event has been triggered of restaurantList sPage');
		try{
			Android.setText("NotHomePage");
		}catch(ex){
			console.log(ex.message);
	...
	appContent.scroll(function(){
		if(appContent.scrollTop() >= (restaurantListContainer.height() - appContent.height()))
	    {
	        if(!loading && moreAvailable){
	        	loadMoreRestaurant();
	        }
	...
	var offset = 1;
	var url = API_URL + '/restaurant/list';
	var params = {appKey: APIKEY, offset: offset};


	//restaurant template variables
	var $temp = $(page).find('.restaurant').remove();
	var $star = $temp.find('.material-icons').remove();

	setTimeout(function(){loadMoreRestaurant();}, 1000);

	function loadMoreRestaurant(){
		loading = true;
		$('.progress').show();
			...
			success: function(data){
				...
				if(!data.response.length == 0){
					data.response.forEach(function(item){
						...
						restaurantListContainer.append($temp2);
					});
				}
				initComponents();
				loading = false;
	...
	//Get restaurant id and date of clicked restaurant and send it to restaurant single page
	$(page).on('click', '.restaurant', function(){
		App.load('restaurant', {id: $(this).data('id'), date: $(this).data('date')});
	})

});

App.controller('restaurant', function(page, data){
	var swiperContainer = $(page).find('.swiper-container');
	var appContent 		= $(page).find('.app-content');
	var mainContainer 	= $(page).find('#restaurantDetailsContainer'); mainContainer.hide();
	console.log(data);
	...
	$(page).on('appShow', function(){
		console.log('appShow event has been triggered of restaurantDetailsPage');
	...
	setTimeout(function(){
		$.ajax({
			url: API_URL + '/restaurant/details',
			method: 'GET',
			dataType: 'JSON',
			data: {appKey: APIKEY, id: data.id},
			success: function(data){
				console.log(data.response);
				gallery = data.response.restaurant.sliderImages;
				data.response.restaurant.sliderImages.forEach(function(item){
					var $slide = $swiperSlide.clone(true);
					$slide.find('img').attr('src', item.fullImage);
					$slide.find('img').addClass('b-lazy');
					mySwiper.appendSlide($slide);
				...
				var pageTitle 		= $(page).find('.app-title');
				pageTitle.html(data.response.restaurant.title);

				$(page).find('#description').find('.desc').html(data.response.restaurant.desc);
	            ...
	            //Set row1 data of table body
	            row1.find('td:first-child').html('Adults '+data.response.restaurant.currSymbol + data.response.restaurant.perAdultPrice);

	            var optTemp = row1.find('td:nth-child(2) > select > option').remove();

	           	for(i = 1; i <= data.response.restaurant.maxAdults; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row1.find('select').append(opt);
	           	...
	           	row1.find('td:nth-child(3)').text(data.response.restaurant.currSymbol+ '' + data.response.restaurant.adultPrice + ' ' + data.response.restaurant.currCode);

	           	//Set row2 data of table body
	           	row2.find('td:first-child').text('Children '+data.response.restaurant.currSymbol + data.response.restaurant.perChildPrice);

	           	for(i = 1; i <= data.response.restaurant.maxChild; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row2.find('select').append(opt);
	           	...
	           	row2.find('td:nth-child(3)').text(data.response.restaurant.currSymbol+ '' + data.response.restaurant.childPrice + ' ' + data.response.restaurant.currCode);

	           	//Set row3 data of table body
	           	row3.find('td:first-child').text('Infants '+data.response.restaurant.currSymbol + data.response.restaurant.perInfantPrice);

	           	for(i = 1; i <= data.response.restaurant.maxInfant; i++){
	            	var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row3.find('select').append(opt);
	            ...
	            row3.find('td:nth-child(3)').text(data.response.restaurant.currSymbol+ '' + data.response.restaurant.infantPrice + ' ' + data.response.restaurant.currCode);

				//Set row4 data of table body
				//Set the date to input[type="date"] format yyyy-mm-dd
				var dateInput = data.response.restaurant.date.split('/').reverse().join('-');
				...
				data.response.restaurant.inclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('green-text');
					inclusions.append(listItem);
				...
				data.response.restaurant.exclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('red-text');
					exclusions.append(listItem);
...
//app #4
App.controller('spaList', function(page, data){
	// Apply theme to topbar and buttons based on current settings.
	if( get(Global.KEY_THEME_TOPBAR)  == 'true') applyTheme( $(page).find('.app-topbar') );
	else applyDefaultTheme ( $(page).find('.app-topbar') );
	if( get(Global.KEY_THEME_BUTTONS) == 'true') applyTheme( $(page).find('.btn') );
	...
	var appContent 		= $(page).find('.app-content');
	var spaListContainer = $(page).find('#spaListContainer');
	spaListContainer.hide();
	...
	$(page).on('appShow', function(){
		initComponents();
		console.log('appShow event has been triggered of spaList Page');
		try{
			Android.setText("NotHomePage");
		}catch(ex){
			console.log(ex.message);
	...
	appContent.scroll(function(){
		if(appContent.scrollTop() >= (spaListContainer.height() - appContent.height()))
	    {
	        if(!loading && moreAvailable){
	        	loadMoreSpa();
	        }
	...
	var offset = 1;
	var url = API_URL + '/spa/list';
	var params = {appKey: APIKEY, offset: offset};


	//spa template variables
	var $temp = $(page).find('.spa').remove();
	var $star = $temp.find('.material-icons').remove();

	setTimeout(function(){loadMoreSpa();}, 1000);

	function loadMoreSpa(){
		loading = true;
		$('.progress').show();
	...
	//Get spa id and date of clicked spa and send it to spa single page
	$(page).on('click', '.spa', function(){
		App.load('spa', {id: $(this).data('id'), date: $(this).data('date')});
	})

});

App.controller('spa', function(page, data){
	var swiperContainer = $(page).find('.swiper-container');
	var appContent 		= $(page).find('.app-content');
	var mainContainer 	= $(page).find('#spaDetailsContainer'); mainContainer.hide();
	console.log(data);
	...
	$(page).on('appShow', function(){
		console.log('appShow event has been triggered of spaDetailsPage');
	...
	setTimeout(function(){
		$.ajax({
			url: API_URL + '/spa/details',
			method: 'GET',
			dataType: 'JSON',
			data: {appKey: APIKEY, id: data.id},
			success: function(data){
				console.log(data.response);
				gallery = data.response.spa.sliderImages;
				data.response.spa.sliderImages.forEach(function(item){
					var $slide = $swiperSlide.clone(true);
					$slide.find('img').attr('src', item.fullImage);
					$slide.find('img').addClass('b-lazy');
					mySwiper.appendSlide($slide);
				...
				var pageTitle 		= $(page).find('.app-title');
				pageTitle.html(data.response.spa.title);

				$(page).find('#description').find('.desc').html(data.response.spa.desc);
	            ...
	            //Set row1 data of table body
	            row1.find('td:first-child').html('Adults '+data.response.spa.currSymbol + data.response.spa.perAdultPrice);

	            var optTemp = row1.find('td:nth-child(2) > select > option').remove();

	           	for(i = 1; i <= data.response.spa.maxAdults; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row1.find('select').append(opt);
	           	...
	           	row1.find('td:nth-child(3)').text(data.response.spa.currSymbol+ '' + data.response.spa.adultPrice + ' ' + data.response.spa.currCode);

	           	//Set row2 data of table body
	           	row2.find('td:first-child').text('Children '+data.response.spa.currSymbol + data.response.spa.perChildPrice);

	           	for(i = 1; i <= data.response.spa.maxChild; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row2.find('select').append(opt);
	           	...
	           	row2.find('td:nth-child(3)').text(data.response.spa.currSymbol+ '' + data.response.spa.childPrice + ' ' + data.response.spa.currCode);

	           	//Set row3 data of table body
	           	row3.find('td:first-child').text('Infants '+data.response.spa.currSymbol + data.response.spa.perInfantPrice);

	           	for(i = 1; i <= data.response.spa.maxInfant; i++){
	            	var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row3.find('select').append(opt);
	            ...
	            row3.find('td:nth-child(3)').text(data.response.spa.currSymbol+ '' + data.response.spa.infantPrice + ' ' + data.response.spa.currCode);

				//Set row4 data of table body
				//Set the date to input[type="date"] format yyyy-mm-dd
				var dateInput = data.response.spa.date.split('/').reverse().join('-');
				...
				data.response.spa.inclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('green-text');
					inclusions.append(listItem);
				...
				data.response.spa.exclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('red-text');
					exclusions.append(listItem);
...
//app #5
App.controller('weddingList', function(page, data){
	// Apply theme to topbar and buttons based on current settings.
	if( get(Global.KEY_THEME_TOPBAR)  == 'true') applyTheme( $(page).find('.app-topbar') );
	else applyDefaultTheme ( $(page).find('.app-topbar') );
	if( get(Global.KEY_THEME_BUTTONS) == 'true') applyTheme( $(page).find('.btn') );
	...
	var appContent 		= $(page).find('.app-content');
	var weddingListContainer = $(page).find('#weddingListContainer');
	weddingListContainer.hide();
	...
	$(page).on('appShow', function(){
		initComponents();
		console.log('appShow event has been triggered of weddingPage');
		try{
			Android.setText("NotHomePage");
		}catch(ex){
			console.log(ex.message);
	...
	appContent.scroll(function(){
		if(appContent.scrollTop() >= (weddingListContainer.height() - appContent.height()))
	    {
	        if(!loading && moreAvailable){
	        	loadMoreWedding();
	        }
	...
	var offset = 1;
	var url = API_URL + '/wedding/list';
	var params = {appKey: APIKEY, offset: offset};


	//wedding template variables
	var $temp = $(page).find('.wedding').remove();
	var $star = $temp.find('.material-icons').remove();

	setTimeout(function(){loadMoreWedding();}, 1000);

	function loadMoreWedding(){
		loading = true;
		$('.progress').show();
			...
			success: function(data){
				...
				if(!data.response.length == 0){
					data.response.forEach(function(item){
						...
						weddingListContainer.append($temp2);
					});
				}
				initComponents();
				loading = false;
	...
	//Get wedding id and date of clicked wedding and send it to wedding single page
	$(page).on('click', '.wedding', function(){
		App.load('wedding', {id: $(this).data('id'), date: $(this).data('date')});
	})

});

App.controller('wedding', function(page, data){
	var swiperContainer = $(page).find('.swiper-container');
	var appContent 		= $(page).find('.app-content');
	var mainContainer 	= $(page).find('#weddingDetailsContainer'); mainContainer.hide();
	console.log(data);
	...
	$(page).on('appShow', function(){
		console.log('appShow event has been triggered of weddingDetailsPage');
	...
	setTimeout(function(){
		$.ajax({
			url: API_URL + '/wedding/details',
			method: 'GET',
			dataType: 'JSON',
			data: {appKey: APIKEY, id: data.id},
			success: function(data){
				console.log(data.response);
				gallery = data.response.wedding.sliderImages;
				data.response.wedding.sliderImages.forEach(function(item){
					var $slide = $swiperSlide.clone(true);
					$slide.find('img').attr('src', item.fullImage);
					$slide.find('img').addClass('b-lazy');
					mySwiper.appendSlide($slide);
				...
				var pageTitle 		= $(page).find('.app-title');
				pageTitle.html(data.response.wedding.title);

				$(page).find('#description').find('.desc').html(data.response.wedding.desc);
	            ...
	            //Set row1 data of table body
	            row1.find('td:first-child').html('Adults '+data.response.wedding.currSymbol + data.response.wedding.perAdultPrice);

	            var optTemp = row1.find('td:nth-child(2) > select > option').remove();

	           	for(i = 1; i <= data.response.wedding.maxAdults; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row1.find('select').append(opt);
	           	...
	           	row1.find('td:nth-child(3)').text(data.response.wedding.currSymbol+ '' + data.response.wedding.adultPrice + ' ' + data.response.wedding.currCode);

	           	//Set row2 data of table body
	           	row2.find('td:first-child').text('Children '+data.response.wedding.currSymbol + data.response.wedding.perChildPrice);

	           	for(i = 1; i <= data.response.wedding.maxChild; i++){
	           		var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row2.find('select').append(opt);
	           	...
	           	row2.find('td:nth-child(3)').text(data.response.wedding.currSymbol+ '' + data.response.wedding.childPrice + ' ' + data.response.wedding.currCode);

	           	//Set row3 data of table body
	           	row3.find('td:first-child').text('Infants '+data.response.wedding.currSymbol + data.response.wedding.perInfantPrice);

	           	for(i = 1; i <= data.response.wedding.maxInfant; i++){
	            	var opt = optTemp.clone(true);
	           		opt.val(i);
	           		opt.text(i);
	           		row3.find('select').append(opt);
	            ...
	            row3.find('td:nth-child(3)').text(data.response.wedding.currSymbol+ '' + data.response.wedding.infantPrice + ' ' + data.response.wedding.currCode);

				//Set row4 data of table body
				//Set the date to input[type="date"] format yyyy-mm-dd
				var dateInput = data.response.wedding.date.split('/').reverse().join('-');
				...
				data.response.wedding.inclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('green-text');
					inclusions.append(listItem);
				...
				data.response.wedding.exclusions.forEach(function(item){
					var listItem = listItemTemp.clone(true);
					listItem.find('span').text(item.name);
					listItem.find('i').addClass('red-text');
					exclusions.append(listItem);
